    ...
    def __init__(self):
        def gotinfo():
            ...
            if self.gettininfo.isdigit() == True and len(self.gettininfo)!=0:
                self.Text1.insert(INSERT,"Número de quarto Válido""\n")
            else:
            ...
            try:
                ...
                while True:
                    ...
                    if self.gettininfo ==a:
                        ...
                        print("Nome ", "\t", "\t", s.name)
                        print("\n")
                        print("Endereço ", "\t", "\t", s.address)
                        print("\n")
                        print("Telefone ", "\t", "\t", s.mobile_no)
                        print("\n")
                        print("Total ", "\t", "\t", s.price)

                    elif EOFError:
                        if n == 0:
                            print("Não há hóspede no quarto", self.gettininfo)
        ...
        self.Frame1.configure(relief=GROOVE)
        self.Frame1.configure(background="linen")
        ...
        self.Label1.configure(background="linen")
