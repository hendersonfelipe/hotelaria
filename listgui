...
class HOTEL_MANAGMENT_checkin:
    def __init__(self):
        ...
        self.Labelframe1.configure(text="Lista de Todos os Hóspedes")
        self.Labelframe1.configure(font=font11)
        ...
        self.Label1.place(relx=0.35,rely=0.02,height=37,width=117)
        ...
        self.Frame2.place(relx=0.51,rely=0.16,relheight=0.86,relwidth=0.47, y=-31, h=3)
        ...
        self.Label2.place(relx=0.35,rely=0.02,height=37,width=117)
