...
class HOTEL_MANAGMENT_checkin:
    ...
    def __init__(self):
        ...
        def chk_name():
            while True:
                ...
                if len(self.k) !=0 and a != True:
                    self.NAME=self.k
                    self.Text1.insert(INSERT,"Nome foi inserido!""\n")
                    break
                else:
                        self.Text1.insert(INSERT,"Entrada inválida, por favor insira um nome válido.""\n")
                        break
        ...
        def chk_add():
            while True:
                ...
                if len(self.g) !=0 and ak != True:
                    ...
                    self.Text1.insert(INSERT,"Endereço foi inserido!""\n")
                    break
                else:
                        self.Text1.insert(INSERT,"Entrada inválida, por favor insira um endereço válido.""\n")
                        break
        ...
        def chk_mo():
            while True:
                ...
                if self.h.isdigit() == True and len(self.h) !=0 and len(self.h)== 11:
                    self.MOBILE=self.h
                    self.Text1.insert(INSERT,"Telefone foi inserido!""\n")
                    break
                else:
                        self.Text1.insert(INSERT,"Entrada inválida, por favor insira um telefone válido.""\n")
                        break
        ...
        def chk_day():
            while True:
                ...
                if self.l.isdigit() == True and len(self.l) != 0:
                    ...
                    self.Text1.insert(INSERT,"Dias foi inseridos!""\n")
                    break
                else:
                    self.Text1.insert(INSERT,"Entrada inválida, por favor insira um período válido.""\n")
                    break
        ...
        def payment_option(self):
            op = self.p
            if op ==1:
                self.Text1.insert(INSERT,"Sem Desconto.""\n")
            elif op ==2:
                self.price = self.price - ((self.price*10)/100)
                self.Text1.insert(INSERT,"10% de Desconto.""\n")
        ...
        def submit_clicked():
            if self.var1.get() ==1 and self.var2.get() ==0 and self.var3.get() ==0 and self.var4.get() ==0 and self.var5.get() ==1 and self.var6.get() ==0:
                ...
                self.Text1.insert(INSERT,"Dados Incorretos, por favor confira os dados e tente novamente.")
        ...
        font14 = "-family {Segoe UI} -size 14 -weight bold -slant  "\
            "roman -underline 0 -overstrike 0"
        
        font15 = "-family {Segoe UI} -size 16 -weight bold -slant  "\
            "roman -underline 0 -overstrike 0"
        ...
        self.Message2.configure(background="cyan")
        ...
        self.Message3.configure(background="cyan")
        ...
        self.Label3.place(relx=0.07,rely=0.03,height=47,width=334)
        ...
        self.Label3.configure(text='''NOME DO HÓSPEDE''')

        self.Label4 = Label(self.Frame2)
        self.Label4.place(relx=0.03,rely=0.29,height=47,width=334)
        ...
        self.Label4.configure(text='''Nº TELEFONE''')
        ...
        self.Label5.place(relx=0.016,rely=0.16,height=47,width=334)
        ...
        self.Label5.configure(text='''ENDEREÇO''')
        ...
        self.Label6.configure(text='''QUARTO''')
        ...
        self.var1 = IntVar()
        self.Checkbutton1.place(relx=0.1,rely=0.62,relheight=0.11,relwidth=0.14)
        self.Checkbutton1.configure(activebackground="#ffffff")
        self.Checkbutton1.configure(activeforeground="#000000")
        self.Checkbutton1.configure(background="#00EE76")
        self.Checkbutton1.configure(font=font17)
        ...
        self.var2 = IntVar()
        self.Checkbutton2.place(relx=0.13,rely=0.72,relheight=0.11,relwidth=0.14)
        ...
        self.Checkbutton2.configure(font=font17)
        ...
        self.var3 = IntVar()
        self.Checkbutton3.place(relx=0.4,rely=0.62,relheight=0.11,relwidth=0.16)
        ...
        self.Checkbutton3.configure(font=font17)
        ...
        self.var4 = IntVar()
        self.Checkbutton4.place(relx=0.43,rely=0.71,relheight=0.11,relwidth=0.12)
        ...
        self.Checkbutton4.configure(font=font17)
        ...
        self.Checkbutton5.configure(font=font17)
        ...
        self.Checkbutton5.configure(text='''Cartão de Débito/Crédito''')
        self.Checkbutton5.configure(variable=self.var5)

        self.Checkbutton6 = Checkbutton(self.Frame2)
        self.var6 = IntVar()
        self.Checkbutton6.place(relx=0.153,rely=0.9,relheight=0.1,relwidth=0.15)
        ...
        self.Checkbutton6.configure(font=font17)
        ...
        self.Label1.place(relx=0.02,rely=0.43,height=47,width=334)
        ...
        self.Label1.configure(text='''Nº DE DIAS''')
        ...
        self.Message7.place(relx=0.42,rely=0.41,relheight=0.11,relwidth=0.03)
        ...
        self.Message7.configure(width=26)
        ...
        self.Button4.configure(text='''Cadastrar''')
