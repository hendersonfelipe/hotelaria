...
class save:
    def __init__(self,NAME_PRO,ADDRESS_PRO,MOBILE_NO_PRO,ROOM_NO_PRO,PRICE_PRO):
        ...
        print(self.name, self.address, self.mobile, self.room_no, self.price)
    ...
    def __init__(self):
        def check_room():
            ...
            if self.rom.isdigit() == True and len(self.rom)!=0:
                self.Text1.insert(INSERT,"Número de quarto inválido""\n")
                v = int(self.rom)
                f = open("hotel.dat","rb")
                f1 = open("hote.dat","ab")
                n = 0
                try:
                    ...
                    if n == 0:
                        self.Text1.insert(INSERT,"Não foi possível encontrar""\n")
                    elif n == 1:
                        self.Text1.insert(INSERT,"Obrigado " + name1.upper() + " por nos visitar. Volte Sempre!""\n")
                    pass
                f.close()
                f1.close()
                os.remove("hotel.dat")
                ...
                self.Text1.insert(INSERT,"Por favor insira o número do quarto.""\n")
        ...
        self.Label1.configure(text='''Nº DO QUARTO :''')
        ...
        self.Button1.configure(text='''DAR BAIXA NA RESERVA''')
